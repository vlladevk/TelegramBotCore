...
public interface BotEventFactory {
     ...
     *                   {@link org.pl.pcz.yevkov.tgbottest.annotation.BotEventBinding}
     * @return a fully validated {@link RegisteredEvent} containing constructor and DTO metadata
     *
     * @throws org.pl.pcz.yevkov.tgbottest.application.event.exception.InvalidBotEventDefinitionException
